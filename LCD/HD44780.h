...
#define LCD_4BIT_D4_PORT   PORTC     	// port for 4bit data bit 0 		//C0 poz:3 connector...[digits 0,1,...]
#define LCD_4BIT_D4_PIN    0          // pin for 4bit data bit 0  		
#define LCD_4BIT_D5_PORT   PORTC     	// port for 4bit data bit 1 		//C1
#define LCD_4BIT_D5_PIN    1          // pin for 4bit data bit 1  
#define LCD_4BIT_D6_PORT   PORTC     	// port for 4bit data bit 2 		//C2
#define LCD_4BIT_D6_PIN    2          // pin for 4bit data bit 2  
#define LCD_4BIT_D7_PORT   PORTC     	// port for 4bit data bit 3 		//C3
#define LCD_4BIT_D7_PIN    3          // pin for 4bit data bit 3  
#define LCD_RS_PORT      PORTC     	// port for RS line         		//C4 poz:1 connector
#define LCD_RS_PIN       4          // pin  for RS line         
#define LCD_E_PORT       PORTC     	// port for Enable line     		//C5 poz:2 connector
